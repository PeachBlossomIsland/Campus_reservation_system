...
<body onLoad="load_completion()">
	...
	<ul class="d1">
			...
			<li class="d2"><A href="commcheck.jsp?id=<%=ac%>">查看评价</A></li>
			<li class="d2"><A class="hover" href="setpic.jsp?id=<%=ac%>">上传头像</A></li>
...
<div style="text-align:center;">
	<div class="blog-cource">
		<div class="container">
			...
			<form method="post" action="upload?k=tea&id=<%=ac %>" enctype="multipart/form-data">				
