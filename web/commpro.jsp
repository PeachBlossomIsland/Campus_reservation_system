	 	...
	 	//这一部分主要是用AJAX技术进行修改密码和实时地设置空闲和取消空闲时间的代码！
	  	function getMoreContents(k,t)
	  	{
	  		...
	  		if(k=="tea_p_info"){
	  			...
	  			url="teainfo";
	  			request_parameters="k=get_commpro"+"&t="+t+"&ac="+ac;
	  		}
	  		...
	  		if(kind==1)
	  		{
	  			...
	  			for(var i=0;i<json.length;i=i+2)
	  			{
	  				...
	  				var tr = document.createElement("tr");
	  		  		...
	  		  		td1.innerHTML = json[i].toString();//显示学生学号
	  		  		td2.innerHTML =numToC(json[i+1].toString());//显示时间
...
<body onLoad="load_completion();goPage(1,6);">
	...
	<ul class="d1">
			...
			<li class="d2"><A class="hover" href="commpro.jsp?id=<%=ac%>">查看预约</A></li>
