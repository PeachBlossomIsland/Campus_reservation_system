...
<body onLoad="load_completion()">
	...
	<ul class="d1">
			...
			<li class="d2"><A href="comment.jsp?id=<%=ac%>">评价教师</A></li>
			<li class="d2"><A class="hover" href="changepassword1.jsp?id=<%=ac%>">修改密码</A></li>
		...
		<div class="container">
			...
			<div class="login-form">
				<form action="teainfo" method="post">
					<div class="">
						<input  type="hidden" name="k" value="stu_change_passwd"/>
						<p>账号</p>
					...
					<div class="">
						<p>专业领域</p>
						<input type="text" class="name" name="profession" required="" />
					</div>
