		...
		<div class="container">
			<div class="bottom_header_left">
				<p>
					...
					<button  style="background-color:#32CD32; border-style:none" onclick="fun()">个人信息</button>
					&nbsp&nbsp&nbsp&nbsp&nbsp<button  style="background-color:#32CD32; border-style:none" onclick="Sign_out()">退出</button>
				</p>
			</div>
